 ...
 * Function: BF_encrypt
 *
 * Description: Perfoms blowfish encryption
 *
 *            input           |           output
 * ---------------------------|----------------------------
 * <const BF_Key *> key       |
 ...
 * Function: BF_set_key
 *
 * Description: BF_set_key() sets up the BF_KEY key using the len 
 *              bytes long key at data.
 *
 *            input               |           output
 * -------------------------------|--------------------------------
 * <BF_KEY *> key                 |
...
/*********************************************************************************
 * Function: BF_ebc_encrypt
 *
 * Description: BF_ecb_encrypt() is the basic Blowfish encryption and 
 *              decryption function. It encrypts or decrypts the first 
 *              4 bits of in using the key key, putting the result in out.
 *              enc decides if encryption (BF_ENCRYPT) or decryption (BF_DECRYPT) 
 *              shall be performed. The vector pointed at by in and out must be 
 *              64 bits in length, no less. If they are larger, everything after 
 ...
 * <int> enc                  |
 **********************************************************************************/
void BF_ecb_encrypt(const unsigned char *in, unsigned char **outbuf,
         BF_KEY *key, int enc){                                                                  
 ...
 * Function: fs_encrypt
 *
 * Description: encrypt plaintext of length bufsize. Use keystr as the key.
 *
 *            input           |           output
 * ---------------------------|----------------------------
 * <void *> plaintext         | <void *>
 ...
 * Function: fs_decrypt
 *
 * Description: decrypt ciphertext of length bufsize. Use keystr as the key.
 *
 *            input           |           output
 * ---------------------------|----------------------------
